...
if __name__ == '__main__':
    ...
    # Modelo ResNet50 con transferencia de aprendizaje (solo capa final entrenable)
    ...
    # Reemplazar la capa final y permitir su entrenamiento
    ...
    # Solo optimizamos la capa final
